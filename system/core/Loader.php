...
class CI_Loader {
	...
	{
		Log::DebugOut('_ci_load_class(class:'.$class.', params, object_name:'.$object_name.')');
	...
	{
		Log::DebugOut('_ci_init_class(class:'.$class.', prefix:'.$prefix.', config:'.$config.', object_name:'.$object_name.')');
	...
	function _ci_autoloader()
	{
		...
		Log::DebugOut("_ci_autoloader() success");
	}
